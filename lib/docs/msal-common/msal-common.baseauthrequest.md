...
[Home](./index.md) &gt; [@azure/msal-common](./msal-common.md) &gt; [BaseAuthRequest](./msal-common.baseauthrequest.md)
...
```
**References:** [AuthenticationScheme](./msal-common.authenticationscheme.md)<!-- -->, [ShrOptions](./msal-common.shroptions.md)<!-- -->, [AzureCloudOptions](./msal-common.azurecloudoptions.md)<!-- -->, [StringDict](./msal-common.stringdict.md)<!-- -->, [StoreInCache](./msal-common.storeincache.md)
